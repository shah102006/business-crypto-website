...
async function fetchRealPrices() {
    try {
        const response = await (0, node_fetch_1.default)('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,solana,ripple,cardano&vs_currencies=usd&include_market_cap=true&include_24hr_vol=true&include_24hr_change=true');
